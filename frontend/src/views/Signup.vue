<template>
    ...
    <div class="signup-container">
        <form @submit.prevent="signup">
            ...
            <button class="btn btn-primary" type="submit" :disabled="!createButtonEnabled">
                Create Account
            </button>
        </form>
...
const validateUsername = () => {
    ...
    else if (!regex.test(username.value)) errors.username = 'Only letters, numbers, _';
};
...
const signup = async () => {
    ...
    const response = await userStore.signup(new User(new ObjectId().toHexString(),username.value, email.value, password.value, [], "web"));
    if (response === true) {
